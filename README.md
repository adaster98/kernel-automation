# Aster's Kernel Build Automation 
A personal script for automating gentoo kernel building. It relies on Gentoo's eselect tool.
...
- Has a choice of 4 bootloaders. I've only tested systemd-boot and asterboot though. Limine and GRUB should work fine
...
## INSTALLATION:
1. Create a folder. 
2. Place script and config file inside.
